//
//  IEMetroLinkStopViewController.h
//  IETrains
//
...
@interface IEMetroLinkStopViewController : UIViewController
...
@property (weak, nonatomic) IBOutlet UILabel *stop_zone_id_lbl;
@property (weak, nonatomic) IBOutlet UILabel *stop_url_lbl;
